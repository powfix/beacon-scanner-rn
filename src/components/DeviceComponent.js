          ...
          <View style={{flex: 1, flexDirection: 'row', paddingVertical: 15, paddingLeft: 10, paddingRight: 18}}>
            ...
            <View style={{flexDirection: 'column', alignItems: 'flex-end'}}>
              <View style={{flexDirection: 'row', alignItems: 'center'}}>
                <Text style={{alignSelf: 'center', marginLeft: 8, fontSize: 12, fontWeight: 'bold', color: 'black'}}><Text>avg. </Text>{this.props.device.rssiAverage(this.props.average_pool_size)}({this.props.average_pool_size})</Text>
